...
def main():
    ...
    if model_args.model_name_or_path is not None:
        ...
        config.box_coord_dim = int(model_args.box_coord_dim)
        config.text_config.block_size = int(model_args.block_size)
        config.text_config.box_coord_dim = int(model_args.box_coord_dim)
        ...
        model.language_model.box_coord_dim = int(model_args.box_coord_dim)
