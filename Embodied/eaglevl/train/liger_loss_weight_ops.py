...
def fused_linear_cross_entropy_forward(
    ...
    for chunk_id in range(num_chunks):
        ...
        # if chunk_id == 0:
        #     print("target_chunk[0]", target_chunk)
        ...
        # if chunk_id == 0:
        #     print("logits_chunk[0]1", logits_chunk[0])
        target_chunk = target_chunk.contiguous()
        # if chunk_id == 0:
        #     print("target_chunk[0]", target_chunk[0])
        ...
        # if chunk_id == 0:
        #     print("loss_1d_slice[0]", loss_1d_slice[0])
        ...
        if loss_weight is not None:
            ...
            # print("loss_weight_chunk", loss_weight_chunk.shape)
            ...
            # if chunk_id == 0:
            #     print("loss_1d[0]", loss_1d[0])
            # if chunk_id == 0:
            #     print("logits_chunk[0]3", logits_chunk[0], logits_chunk.mean())
            grad_logits_chunk = logits_chunk * alpha  # chunk_size x V
            # if chunk_id == 0:
            #     print("grad_logits_chunk[0]", grad_logits_chunk[0])
