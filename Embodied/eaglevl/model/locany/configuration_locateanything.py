...
class LocateAnythingConfig(PretrainedConfig):
    ...
    def __init__(
            ...
            # 4 is the released horizontal-box protocol.  Set this to 5 for
            # <cx><cy><w><h><angle> rotated boxes, or 8 for four-vertex OBBs.
            box_coord_dim=4,
            **kwargs):
        super().__init__(**kwargs)
        ...
        self.box_coord_dim = box_coord_dim  #&&# newly added
    ...
    def to_dict(self):
        ...
        output['box_coord_dim'] = self.box_coord_dim    #&&# newly added
