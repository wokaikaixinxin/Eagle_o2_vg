...
# (https://github.com/OpenGVLab/InternVL), licensed under the MIT License [see LICENSE for details].
# The InternVL project includes components modified from
# hreikin/streamlit-uploads-library (https://github.com/hreikin/streamlit-uploads-library),
...
# Copyright (c) 2023 Michael Haslam
