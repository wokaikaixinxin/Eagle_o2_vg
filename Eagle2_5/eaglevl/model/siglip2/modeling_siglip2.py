...
class Rope2DPosEmb(nn.Module):
    ...
    def get_freqs_cis(self, win_meta_list: List[Dict], device: torch.device) -> torch.Tensor:
        ...
        # assert all xy <512
        assert all(win_meta['win_xy'][0] + win_meta['win_hw'][0] < 512 and win_meta['win_xy'][1] + win_meta['win_hw'][1] < 512 for win_meta in win_meta_list), f"win_meta_list: {win_meta_list}"
